...
const QuizDetails = ({ questions }) => {
    ...
    return (
        <div>
            <div className='sm:w-[80%] lg:w-[50%] m-auto'>
                ...
                <div className=' h-full py-10  bg-white-500 shadow-lg rounded-lg mt-20 shadow-green-800 pt-2 '>
                    ...
                    <div className='grid my-10 sm:grid-cols-1  lg:grid-cols-2 gap-4 '>
                        ...
                        <div className=' flex items-center p-2 mx-5 h-[100px] w-[90%] border-2 border-green-200 rounded-lg cursor-pointer '>
                    ...
                    <div className='grid my-10  sm:grid-cols-1 lg:grid-cols-2 gap-4'>
                        <div className='p-2 flex items-center h-[100px] w-[90%] mx-5 border-2 border-green-200 rounded-lg cursor-pointer'>

                            <h1 onClick={(e) => quesHandleClick(e)}>{questions.options[2]}</h1>
                        </div>
                        <div className=' p-2 flex items-center mx-5 h-[100px] w-[90%] border-2 border-green-200 rounded-lg cursor-pointer '>
